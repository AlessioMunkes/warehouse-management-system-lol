...
const createSettings = async (data) => {
  ...
  const result = await pool.query(
    `INSERT INTO certificate_settings (
      organisation_name, logo_url, pbo_number, npo_number, section18a_reference,
      physical_address, postal_address, contact_email, contact_phone, website,
      sender_display_name, reply_to_email, subject_template,
      footer_text, certificate_prefix, signature_name, signature_title,
      default_acknowledgement_message
    ) VALUES (
    ...
    ON CONFLICT (id) DO UPDATE SET
      ...
      npo_number = EXCLUDED.npo_number,
