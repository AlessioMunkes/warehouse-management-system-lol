...
describe('Section18AManagementPage', () => {
  it('renders queue with donor, reference, date, amount, donation status, and Section 18A status', async () => {
  ...
  it('does NOT display any manual Generate or Regenerate buttons in the queue', async () => {
    render(<Section18AManagementPage />);
  ...
  it('renders Download button for generated certificates and triggers download', async () => {
    ...
    expect(api.downloadCertificate).toHaveBeenCalledWith('DON-1002');
  });
